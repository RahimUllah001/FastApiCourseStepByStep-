...
class Post(Base):
    ...
    owner = relationship("User")        #this relationship in sqlalchemy property which save all the iformation inside  given class to his varaible as here a var is owner and class is User
